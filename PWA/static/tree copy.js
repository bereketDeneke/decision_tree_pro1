...
function input_search() {
    ...
    if(result.length == 0) {
        ...
        text.innerHTML += "<input onclick=" + "showOrHideResultsX(result)" + " type='button' value='Expand'/>";
        ...
        text.innerHTML += "<input onclick=" + "showOrHideResultsY(result)" + "  type='button' value='Expand'/>";
        ...
        text.innerHTML += "<input onclick=" + "showOrHideResultsZ(result)" + "  type='button' value='Expand'/>";
